...
public partial class MainWindow : Window
{
    ...
    private ItemVm? BuildVm(QuickMenuItem item)
    {
        string subtitle;
    ...
    public void AddItemsAndSave(IEnumerable<QuickMenuItem> newItems)
    {
    ...
    private QuickMenuItem? _pendingDelete;
    ...
    private void SwapItems(QuickMenuItem a, QuickMenuItem b)
    {
        var list = _config.Items;
